      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-8 relative z-10">
        <div className="mb-8 text-center" data-aos="fade-up">
          ...
          <div className="mt-4 flex justify-center">
            <a
              href="https://www.betaserrata.de"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-[#8c6a45] bg-white px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.18em] text-[#8c6a45] shadow-sm transition hover:bg-[#8c6a45] hover:text-white"
            >
              ...
              <svg
                ...
                strokeWidth="2"
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h9m0 0H9m5-5l5 5-5 5" />
              </svg>
            </a>
          </div>
        </div>
